...
<head>
    ...
    <!-- Sweet Alert -->
    <link type="text/css" href="{{ secure_asset('vendor/sweetalert2/dist/sweetalert2.min.css') }}" rel="stylesheet">

    <!-- Font Awesome ICON -->
    <script src="https://kit.fontawesome.com/091b217840.js" crossorigin="anonymous"></script>

    <!-- Volt CSS -->
    <link type="text/css" href="{{ secure_asset('css/volt.css') }}" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
        <a class="navbar-brand me-lg-5" href="../../index.html">
            <img class="navbar-brand-dark" src="{{ secure_asset('img/light.svg') }}" alt="Volt logo" />
        </a>
                ...
                <li class="nav-item">
                    <a href="/" class="nav-link d-flex align-items-center">
                        <span class="sidebar-icon">
                            <img src="{{ secure_asset('img/light.svg') }}" height="20" width="20" alt="SIG Logo">
                        </span>
    ...
    <!-- Core -->
    <script src="{{ secure_asset('vendor/@popperjs/core/dist/umd/popper.min.js') }}"></script>
    <script src="{{ secure_asset('vendor/bootstrap/dist/js/bootstrap.min.js') }}"></script>

    <!-- Sweet Alerts 2 -->
    <script src="{{ secure_asset('vendor/sweetalert2/dist/sweetalert2.all.min.js') }}"></script>

    @stack('scripts')
    <!-- Volt JS -->
    <script src="{{ secure_asset('js/volt.js') }}"></script>
