                    ...
                    <div class="card-body">
                        <form action="{{ route('shops.update', $shop) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row row">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="lng" id="lng"
                                            ...
                                            placeholder="lng" value="{{ $shop->lng }}">
                                        @error('lng')
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="lat" id="lat" value="{{ $shop->lat }}"
                                ...
                                <div class="form-row row">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Shop name here..." value="{{ $shop->name }}">
                                        @error('name')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="address"
                                            ...
                                            placeholder="Address Description..." value="{{ $shop->address }}">
                                        @error('address')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group float-right mt-4">
                                <button type="submit" class="btn btn-primary bg-black">Update Shop</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                console.log("titik ditemukan", mapCenter);
            });
        } else {
